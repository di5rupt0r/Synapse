...
def test_bm25_search_basic():
    ...
    assert "chunk:123e4567-e89b-12d3-a456-426614174001" in chunk_ids  # hello_world function
    assert "chunk:123e4567-e89b-12d3-a456-426614174002" in chunk_ids  # Hello, World print
