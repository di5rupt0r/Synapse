...
class TestUniXCoderBackend:
    ...
    def test_initialization_cuda_available(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
    ...
    @patch("synapse.embeddings.unixcoder.AutoTokenizer")
    @patch("synapse.embeddings.unixcoder.AutoModel")
    def test_initialization_cpu_only(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
    ...
    @patch("synapse.embeddings.unixcoder.AutoTokenizer")
    @patch("synapse.embeddings.unixcoder.AutoModel")
    def test_initialization_custom_model(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
        ...
        mock_auto_tokenizer.from_pretrained.assert_called_once_with("custom/unixcoder-model")
        mock_auto_model.from_pretrained.assert_called_once_with("custom/unixcoder-model")
    ...
    @patch("synapse.embeddings.unixcoder.AutoTokenizer")
    @patch("synapse.embeddings.unixcoder.AutoModel")
    def test_embed_real_tensor_path(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
        ...
        mock_model = Mock()
        mock_outputs = Mock()
        mock_last_hidden = torch_mock.tensor([[[0.1, 0.2, 0.3]]])  # Will be expanded to 768
    ...
    @patch("synapse.embeddings.unixcoder.AutoTokenizer")
    @patch("synapse.embeddings.unixcoder.AutoModel")
    def test_embed_mock_dict_path(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
    ...
    @patch("synapse.embeddings.unixcoder.AutoTokenizer")
    @patch("synapse.embeddings.unixcoder.AutoModel")
    def test_embed_mock_nested_list_path(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
    ...
    @patch("synapse.embeddings.unixcoder.AutoTokenizer")
    @patch("synapse.embeddings.unixcoder.AutoModel")
    def test_embed_dimension_validation(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
    ...
    @patch("synapse.embeddings.unixcoder.AutoTokenizer")
    @patch("synapse.embeddings.unixcoder.AutoModel")
    def test_embed_batch_real_tensor_path(self, mock_auto_model, mock_auto_tokenizer, mock_cuda):
        ...
        mock_model = Mock()
        mock_outputs = Mock()
        mock_last_hidden = torch_mock.tensor([[[0.1, 0.2]], [[0.3, 0.4]]])  # 2 samples, small dim
        mock_outputs.last_hidden_state = mock_last_hidden
        mock_model.return_value = mock_outputs
        mock_auto_model.from_pretrained.return_value = mock_model
        ...
        assert isinstance(result, list)
        assert len(result) == 2
        mock_tokenizer.assert_called_once_with(["text1", "text2"], return_tensors="pt", truncation=True, max_length=512, padding=True)
